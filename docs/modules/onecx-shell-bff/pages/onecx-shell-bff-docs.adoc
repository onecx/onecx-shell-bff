...
quarkus.cache.caffeine.onecx-shell.metrics-enabled=${ONECX_SHELL_CACHE_SHELL_METRICS_ENABLED:true}
quarkus.cache.caffeine.onecx-shell.expire-after-write=${ONECX_SHELL_CACHE_SHELL_EXPIRE_AFTER:310S}
